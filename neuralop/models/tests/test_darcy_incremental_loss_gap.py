...
model = FNO(n_modes=(30, 30), hidden_channels=32, projection_channels=64, incremental_n_modes=(6, 6))
...
trainer = Trainer(model, n_epochs=500,
                  ...
                  verbose=True, incremental_loss_gap = True, incremental=False, incremental_resolution=False)
