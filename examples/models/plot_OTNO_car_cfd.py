"""
Using OTNO on a Car CFD Dataset
==========================================

Training an OTNO on the saved OT dataset which is generated by the OTDataModule from neuralop.data.datasets.

This tutorial demonstrates how to:
1. Load preprocessed optimal transport (OT) data for car CFD simulations
