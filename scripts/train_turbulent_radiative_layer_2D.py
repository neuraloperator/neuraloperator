...
from neuralop.data.datasets.the_well import Turbulent2DDataset
...
pipe = ConfigPipeline(
    [
        YamlConfig(
            "/pscratch/sd/a/aganeshr/projects2/Benchmarking/turbulent2D.yaml", config_name="default", config_folder="../config"
        ),
...
dataset = Turbulent2DDataset(root_dir=Path(config.data.root).expanduser(),
