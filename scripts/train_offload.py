...
from neuralop.training.offload import enable_activation_offload_for_FNO
...
print(model)
# enable_activation_offload_for_FNO(model)
...
print(
    "Peak allocated bytes on cuda:{}: {:4f}GB".format(
        0, torch.cuda.memory_stats(0)["allocated_bytes.all.peak"] / 2**30
    )
)
