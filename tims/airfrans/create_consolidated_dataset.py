    ...
    for grid_size in grid_sizes:
        ...
        for split_name, sim_dirs in splits_config.items():
            ...
            for sim_dir in tqdm(sim_dirs, desc=f"Loading {split_name}"):
                ...
                data_file = sim_path / f"{sim_dir}_X{int(xlim)}_Y{int(ylim)}_G{grid_size}x{grid_size}.pt"
            ...
            if all_x:
                ...
                output_file = output_dir / f"airfoil_{split_name}_{grid_size}.pt"
...
def main():
    ...
    output_dir = Path("/home/timm/Projects/PIML/neuraloperator/tims/airfrans/consolidated_data")
