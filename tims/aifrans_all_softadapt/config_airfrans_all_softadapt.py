...
class AirfransDatasetAllSoftAdapt(ConfigBase):
    ...
    channel_dim: int = 1
    weights: Dict[str, float] = {"u": 1.0, "v": 1.0, "Cp": 1.0, "nut": 1.0}  # Weights for [u, v, Cp, nut] in loss calculation
...
class Default(ConfigBase):
    ...
    data: AirfransDatasetAllSoftAdapt = AirfransDatasetAllSoftAdapt()
