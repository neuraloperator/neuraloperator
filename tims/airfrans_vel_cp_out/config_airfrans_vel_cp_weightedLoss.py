...
class AirfransDatasetVelocityCp(ConfigBase):
    ...
    channel_dim: int = 1
    weights: List[float] = [1.0, 1.0, 1.0]  # Weights for [u, v, Cp] in loss calculation
...
class Default(ConfigBase):
    ...
    data: AirfransDatasetVelocityCp = AirfransDatasetVelocityCp()
