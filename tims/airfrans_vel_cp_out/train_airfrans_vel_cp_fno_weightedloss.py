...
from tims.airfrans_vel_cp_out.airfrans_trainer import AirfransVelCpTrainer
from tims.airfrans_vel_cp_out.airfrans_dataset_vel_cp import load_airfrans_dataset

from tims.airfrans_vel_cp_out.config_airfrans_vel_cp_weightedLoss import Default
import pandas as pd
import matplotlib.pyplot as plt
...
class WeightedL2Loss(torch.nn.Module):
    def __init__(self, weights=[1.0, 1.0, 1.0], reduction='sum'):
        """
...
checkpoint_dir = Path("./tims/airfrans_vel_cp_out/checkpoints-velocity-weighted-L2")
# Ensure the trainer is set to 1 epoch internally
#trainer.n_epochs = 1
output_dir ="/home/timm/Projects/PIML/neuraloperator/tims/airfrans_vel_cp_out/results_velocity_weighted_L2"
        

trainer = AirfransVelCpTrainer(
    model=model,
