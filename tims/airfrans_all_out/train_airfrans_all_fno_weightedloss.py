...
eval_losses = {"trainLoss":train_loss, "h1": h1loss, "l2": l2loss, "weighted_l1": eval_weighted_l1, "weighted_l2": eval_weighted_l2}
...
trainer.train(
    ...
    save_every=20,
    #   save_best=20,  # Not working as expected with 128_weightedl2
